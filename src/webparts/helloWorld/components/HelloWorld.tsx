...
private async _createSite() {
  ...
  if (selectedItem.webTemplate === "64") {
    ...
    const siteCreated = await this.createTeamSite(siteName, siteName, true, 1033, "", "", null, selectedItem.key);
  ...
  // If communication site
    ...
    const siteCreated = await this.createCommunicationSite(siteName, 1033, siteUrl, selectedItem.key);
